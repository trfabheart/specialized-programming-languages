...
class ArtOperations:
    ...
    def load_characters(self):
        for char in "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#_+-:,. ":
            if char.isupper():
                filename = f"C:/Users/User/Desktop/nulp-3/Спеціалізовані мови програмування/Lab4/Assets/letters/{char}{char}.txt"
            elif char.islower():
                filename = f"C:/Users/User/Desktop/nulp-3/Спеціалізовані мови програмування/Lab4/Assets/letters/{char}.txt"
            elif char.isdigit():
                filename = f"C:/Users/User/Desktop/nulp-3/Спеціалізовані мови програмування/Lab4/Assets/numbers/{char}.txt"
            else:
                filename = f"C:/Users/User/Desktop/nulp-3/Спеціалізовані мови програмування/Lab4/Assets/symbols/{char}.txt"
