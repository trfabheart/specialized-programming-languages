...
class ArtOperations:
    ...
    def load_characters(self):
        for char in "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#_+-:,. ":
            if char.isupper():
                filename = f"/Users/admin/Desktop/ДЗ/3 семестр/000/Спеціалізовані мови програмування/Laba9/Lab4/Assets/letters/{char}{char}.txt"
            elif char.islower():
                filename = f"/Users/admin/Desktop/ДЗ/3 семестр/000/Спеціалізовані мови програмування/Laba9/Lab4/Assets/letters/{char}.txt"
            elif char.isdigit():
                filename = f"/Users/admin/Desktop/ДЗ/3 семестр/000/Спеціалізовані мови програмування/Laba9/Lab4/Assets/numbers/{char}.txt"
            else:
                filename = f"/Users/admin/Desktop/ДЗ/3 семестр/000/Спеціалізовані мови програмування/Laba9/Lab4/Assets/symbols/{char}.txt"
